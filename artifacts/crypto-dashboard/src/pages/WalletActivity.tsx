        ...
        <div className="bg-red-900/20 border border-red-800/50 rounded-2xl p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-gray-300 text-xs leading-relaxed">
              {WALLET_TRANSACTIONS.filter(t => t.type === "sent").length} outbound USDT transactions were recorded from Nicholas's wallet to an external address. Total drained: <span className="text-red-400 font-bold">{TOTAL_SENT.toFixed(2)} USDT</span>
            </p>
          </div>
        </div>
        ...
        {activeTab === "wallet" && (
          <div className="space-y-4">
            <div className="bg-[#0d1117] rounded-2xl border border-[#1e2530] p-4">
              <p className="text-gray-400 text-xs uppercase tracking-wider mb-3 font-semibold">Nicholas's Wallet Address</p>
        ...
        {activeTab === "recipient" && (
          <div className="space-y-4">
            <div className="bg-red-900/20 border border-red-800/50 rounded-2xl p-4">
              ...
              <p className="text-gray-300 text-xs">All outbound transactions from Nicholas's wallet were routed to this address.</p>
            </div>
