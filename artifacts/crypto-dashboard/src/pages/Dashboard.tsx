...
import { Eye, EyeOff, Plus, TrendingUp, TrendingDown, Zap, Gift, Bell, ArrowUpRight, ArrowDownLeft, ArrowDown, RefreshCw, Loader2 } from "lucide-react";
            ...
            <div className="mx-4 mt-5 mb-4">
              ...
              <div className="space-y-2.5">
                {portfolioCoins.length > 0 ? portfolioCoins.map((coin) => {
                  ...
                  [
                    { id: "bitcoin", name: "Bitcoin", symbol: "BTC", amount: "3.5144", value: <Loader2 className="w-5 h-5 animate-spin ml-auto" />, change: "+1.31%", up: true, color: "#f7931a", letter: "B", alloc: 100 },
                  ].map((a) => (
